...
module niosII_cpu (
	...
	niosII_cpu_cpu cpu (
		...
		.itcm0_waitrequest                   (itcm0_waitrequest),                   //                                     .waitrequest
		.itcm0_address                       (itcm0_address),                       //                                     .address
		.itcm0_read                          (itcm0_read),                          //                                     .read
		.itcm0_clken                         (itcm0_clken),                         //                                     .clken
		.itcm0_readdatavalid                 (itcm0_readdatavalid),                 //                                     .readdatavalid
		.irq                                 (irq),                                 //                                  irq.irq
