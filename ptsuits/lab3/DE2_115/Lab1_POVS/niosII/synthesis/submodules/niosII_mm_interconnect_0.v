...
module niosII_mm_interconnect_0 (
		...
		output wire [0:0]  my_pwm_avalon_slave_0_address,                     //               my_pwm_avalon_slave_0.address
	...
	wire   [11:0] cmd_mux_001_src_channel;                                                   // cmd_mux_001:src_channel -> my_pwm_avalon_slave_0_agent:cp_channel
	...
	wire   [11:0] cmd_mux_003_src_channel;                                                   // cmd_mux_003:src_channel -> performance_counter_0_control_slave_agent:cp_channel
	...
	wire   [11:0] cmd_mux_005_src_channel;                                                   // cmd_mux_005:src_channel -> seven_seg_s1_agent:cp_channel
	...
	wire   [11:0] cmd_mux_006_src_channel;                                                   // cmd_mux_006:src_channel -> buttons_s1_agent:cp_channel
	...
	wire   [11:0] cmd_mux_007_src_channel;                                                   // cmd_mux_007:src_channel -> sys_clk_timer_s1_agent:cp_channel
	...
	wire   [11:0] cmd_mux_008_src_channel;                                                   // cmd_mux_008:src_channel -> high_res_timer_s1_agent:cp_channel
	...
	wire          cmd_mux_009_src_valid;                                                     // cmd_mux_009:src_valid -> instruction_tcm_s2_agent:cp_valid
	wire  [103:0] cmd_mux_009_src_data;                                                      // cmd_mux_009:src_data -> instruction_tcm_s2_agent:cp_data
	wire          cmd_mux_009_src_ready;                                                     // instruction_tcm_s2_agent:cp_ready -> cmd_mux_009:src_ready
	wire   [11:0] cmd_mux_009_src_channel;                                                   // cmd_mux_009:src_channel -> instruction_tcm_s2_agent:cp_channel
	wire          cmd_mux_009_src_startofpacket;                                             // cmd_mux_009:src_startofpacket -> instruction_tcm_s2_agent:cp_startofpacket
	wire          cmd_mux_009_src_endofpacket;                                               // cmd_mux_009:src_endofpacket -> instruction_tcm_s2_agent:cp_endofpacket
	...
	wire  [103:0] instruction_tcm_s2_agent_rp_data;                                          // instruction_tcm_s2_agent:rp_data -> router_011:sink_data
	...
	wire          ext_ram_ctl_uas_agent_rp_valid;                                            // ext_ram_ctl_uas_agent:rp_valid -> router_012:sink_valid
	wire   [85:0] ext_ram_ctl_uas_agent_rp_data;                                             // ext_ram_ctl_uas_agent:rp_data -> router_012:sink_data
	wire          ext_ram_ctl_uas_agent_rp_ready;                                            // router_012:sink_ready -> ext_ram_ctl_uas_agent:rp_ready
	wire          ext_ram_ctl_uas_agent_rp_startofpacket;                                    // ext_ram_ctl_uas_agent:rp_startofpacket -> router_012:sink_startofpacket
	wire          ext_ram_ctl_uas_agent_rp_endofpacket;                                      // ext_ram_ctl_uas_agent:rp_endofpacket -> router_012:sink_endofpacket
	wire          ext_flash_ctl_uas_agent_rp_valid;                                          // ext_flash_ctl_uas_agent:rp_valid -> router_013:sink_valid
	wire   [76:0] ext_flash_ctl_uas_agent_rp_data;                                           // ext_flash_ctl_uas_agent:rp_data -> router_013:sink_data
	wire          ext_flash_ctl_uas_agent_rp_ready;                                          // router_013:sink_ready -> ext_flash_ctl_uas_agent:rp_ready
	wire          ext_flash_ctl_uas_agent_rp_startofpacket;                                  // ext_flash_ctl_uas_agent:rp_startofpacket -> router_013:sink_startofpacket
	wire          ext_flash_ctl_uas_agent_rp_endofpacket;                                    // ext_flash_ctl_uas_agent:rp_endofpacket -> router_013:sink_endofpacket
	...
	wire   [11:0] ext_ram_ctl_uas_burst_adapter_source0_channel;                             // ext_ram_ctl_uas_burst_adapter:source0_channel -> ext_ram_ctl_uas_agent:cp_channel
	...
	wire   [11:0] ext_flash_ctl_uas_burst_adapter_source0_channel;                           // ext_flash_ctl_uas_burst_adapter:source0_channel -> ext_flash_ctl_uas_agent:cp_channel
	...
	wire  [103:0] cmd_demux_001_src1_data;                                                   // cmd_demux_001:src1_data -> cmd_mux_010:sink1_data
	...
	wire  [103:0] cmd_demux_001_src2_data;                                                   // cmd_demux_001:src2_data -> cmd_mux_011:sink1_data
	...
	wire  [103:0] rsp_demux_010_src1_data;                                                   // rsp_demux_010:src1_data -> rsp_mux_001:sink1_data
	...
	wire  [103:0] rsp_demux_011_src1_data;                                                   // rsp_demux_011:src1_data -> rsp_mux_001:sink2_data
	...
	wire          router_012_src_valid;                                                      // router_012:src_valid -> ext_ram_ctl_uas_rsp_width_adapter:in_valid
	wire   [85:0] router_012_src_data;                                                       // router_012:src_data -> ext_ram_ctl_uas_rsp_width_adapter:in_data
	wire          router_012_src_ready;                                                      // ext_ram_ctl_uas_rsp_width_adapter:in_ready -> router_012:src_ready
	wire   [11:0] router_012_src_channel;                                                    // router_012:src_channel -> ext_ram_ctl_uas_rsp_width_adapter:in_channel
	wire          router_012_src_startofpacket;                                              // router_012:src_startofpacket -> ext_ram_ctl_uas_rsp_width_adapter:in_startofpacket
	wire          router_012_src_endofpacket;                                                // router_012:src_endofpacket -> ext_ram_ctl_uas_rsp_width_adapter:in_endofpacket
	wire          ext_ram_ctl_uas_rsp_width_adapter_src_valid;                               // ext_ram_ctl_uas_rsp_width_adapter:out_valid -> rsp_demux_010:sink_valid
	wire  [103:0] ext_ram_ctl_uas_rsp_width_adapter_src_data;                                // ext_ram_ctl_uas_rsp_width_adapter:out_data -> rsp_demux_010:sink_data
	wire          ext_ram_ctl_uas_rsp_width_adapter_src_ready;                               // rsp_demux_010:sink_ready -> ext_ram_ctl_uas_rsp_width_adapter:out_ready
	wire   [11:0] ext_ram_ctl_uas_rsp_width_adapter_src_channel;                             // ext_ram_ctl_uas_rsp_width_adapter:out_channel -> rsp_demux_010:sink_channel
	wire          ext_ram_ctl_uas_rsp_width_adapter_src_startofpacket;                       // ext_ram_ctl_uas_rsp_width_adapter:out_startofpacket -> rsp_demux_010:sink_startofpacket
	wire          ext_ram_ctl_uas_rsp_width_adapter_src_endofpacket;                         // ext_ram_ctl_uas_rsp_width_adapter:out_endofpacket -> rsp_demux_010:sink_endofpacket
	wire          router_013_src_valid;                                                      // router_013:src_valid -> ext_flash_ctl_uas_rsp_width_adapter:in_valid
	wire   [76:0] router_013_src_data;                                                       // router_013:src_data -> ext_flash_ctl_uas_rsp_width_adapter:in_data
	wire          router_013_src_ready;                                                      // ext_flash_ctl_uas_rsp_width_adapter:in_ready -> router_013:src_ready
	wire   [11:0] router_013_src_channel;                                                    // router_013:src_channel -> ext_flash_ctl_uas_rsp_width_adapter:in_channel
	wire          router_013_src_startofpacket;                                              // router_013:src_startofpacket -> ext_flash_ctl_uas_rsp_width_adapter:in_startofpacket
	wire          router_013_src_endofpacket;                                                // router_013:src_endofpacket -> ext_flash_ctl_uas_rsp_width_adapter:in_endofpacket
	wire          ext_flash_ctl_uas_rsp_width_adapter_src_valid;                             // ext_flash_ctl_uas_rsp_width_adapter:out_valid -> rsp_demux_011:sink_valid
	wire  [103:0] ext_flash_ctl_uas_rsp_width_adapter_src_data;                              // ext_flash_ctl_uas_rsp_width_adapter:out_data -> rsp_demux_011:sink_data
	wire          ext_flash_ctl_uas_rsp_width_adapter_src_ready;                             // rsp_demux_011:sink_ready -> ext_flash_ctl_uas_rsp_width_adapter:out_ready
	wire   [11:0] ext_flash_ctl_uas_rsp_width_adapter_src_channel;                           // ext_flash_ctl_uas_rsp_width_adapter:out_channel -> rsp_demux_011:sink_channel
	wire          ext_flash_ctl_uas_rsp_width_adapter_src_startofpacket;                     // ext_flash_ctl_uas_rsp_width_adapter:out_startofpacket -> rsp_demux_011:sink_startofpacket
	wire          ext_flash_ctl_uas_rsp_width_adapter_src_endofpacket;                       // ext_flash_ctl_uas_rsp_width_adapter:out_endofpacket -> rsp_demux_011:sink_endofpacket
	wire          cmd_mux_010_src_valid;                                                     // cmd_mux_010:src_valid -> ext_ram_ctl_uas_cmd_width_adapter:in_valid
	wire  [103:0] cmd_mux_010_src_data;                                                      // cmd_mux_010:src_data -> ext_ram_ctl_uas_cmd_width_adapter:in_data
	wire          cmd_mux_010_src_ready;                                                     // ext_ram_ctl_uas_cmd_width_adapter:in_ready -> cmd_mux_010:src_ready
	wire   [11:0] cmd_mux_010_src_channel;                                                   // cmd_mux_010:src_channel -> ext_ram_ctl_uas_cmd_width_adapter:in_channel
	wire          cmd_mux_010_src_startofpacket;                                             // cmd_mux_010:src_startofpacket -> ext_ram_ctl_uas_cmd_width_adapter:in_startofpacket
	wire          cmd_mux_010_src_endofpacket;                                               // cmd_mux_010:src_endofpacket -> ext_ram_ctl_uas_cmd_width_adapter:in_endofpacket
	...
	wire   [11:0] ext_ram_ctl_uas_cmd_width_adapter_src_channel;                             // ext_ram_ctl_uas_cmd_width_adapter:out_channel -> ext_ram_ctl_uas_burst_adapter:sink0_channel
	...
	wire          cmd_mux_011_src_valid;                                                     // cmd_mux_011:src_valid -> ext_flash_ctl_uas_cmd_width_adapter:in_valid
	wire  [103:0] cmd_mux_011_src_data;                                                      // cmd_mux_011:src_data -> ext_flash_ctl_uas_cmd_width_adapter:in_data
	wire          cmd_mux_011_src_ready;                                                     // ext_flash_ctl_uas_cmd_width_adapter:in_ready -> cmd_mux_011:src_ready
	wire   [11:0] cmd_mux_011_src_channel;                                                   // cmd_mux_011:src_channel -> ext_flash_ctl_uas_cmd_width_adapter:in_channel
	wire          cmd_mux_011_src_startofpacket;                                             // cmd_mux_011:src_startofpacket -> ext_flash_ctl_uas_cmd_width_adapter:in_startofpacket
	wire          cmd_mux_011_src_endofpacket;                                               // cmd_mux_011:src_endofpacket -> ext_flash_ctl_uas_cmd_width_adapter:in_endofpacket
	...
	wire   [11:0] ext_flash_ctl_uas_cmd_width_adapter_src_channel;                           // ext_flash_ctl_uas_cmd_width_adapter:out_channel -> ext_flash_ctl_uas_burst_adapter:sink0_channel
	...
	wire          ext_ram_ctl_uas_agent_rdata_fifo_out_valid;                                // ext_ram_ctl_uas_agent_rdata_fifo:out_valid -> avalon_st_adapter_010:in_0_valid
	wire   [17:0] ext_ram_ctl_uas_agent_rdata_fifo_out_data;                                 // ext_ram_ctl_uas_agent_rdata_fifo:out_data -> avalon_st_adapter_010:in_0_data
	wire          ext_ram_ctl_uas_agent_rdata_fifo_out_ready;                                // avalon_st_adapter_010:in_0_ready -> ext_ram_ctl_uas_agent_rdata_fifo:out_ready
	wire          avalon_st_adapter_010_out_0_valid;                                         // avalon_st_adapter_010:out_0_valid -> ext_ram_ctl_uas_agent:rdata_fifo_sink_valid
	wire   [17:0] avalon_st_adapter_010_out_0_data;                                          // avalon_st_adapter_010:out_0_data -> ext_ram_ctl_uas_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_010_out_0_ready;                                         // ext_ram_ctl_uas_agent:rdata_fifo_sink_ready -> avalon_st_adapter_010:out_0_ready
	wire    [0:0] avalon_st_adapter_010_out_0_error;                                         // avalon_st_adapter_010:out_0_error -> ext_ram_ctl_uas_agent:rdata_fifo_sink_error
	wire          ext_flash_ctl_uas_agent_rdata_fifo_out_valid;                              // ext_flash_ctl_uas_agent_rdata_fifo:out_valid -> avalon_st_adapter_011:in_0_valid
	wire    [9:0] ext_flash_ctl_uas_agent_rdata_fifo_out_data;                               // ext_flash_ctl_uas_agent_rdata_fifo:out_data -> avalon_st_adapter_011:in_0_data
	wire          ext_flash_ctl_uas_agent_rdata_fifo_out_ready;                              // avalon_st_adapter_011:in_0_ready -> ext_flash_ctl_uas_agent_rdata_fifo:out_ready
	wire          avalon_st_adapter_011_out_0_valid;                                         // avalon_st_adapter_011:out_0_valid -> ext_flash_ctl_uas_agent:rdata_fifo_sink_valid
	wire    [9:0] avalon_st_adapter_011_out_0_data;                                          // avalon_st_adapter_011:out_0_data -> ext_flash_ctl_uas_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_011_out_0_ready;                                         // ext_flash_ctl_uas_agent:rdata_fifo_sink_ready -> avalon_st_adapter_011:out_0_ready
	wire    [0:0] avalon_st_adapter_011_out_0_error;                                         // avalon_st_adapter_011:out_0_error -> ext_flash_ctl_uas_agent:rdata_fifo_sink_error
	...
	niosII_mm_interconnect_0_cmd_mux_004 cmd_mux_010 (
		.clk                 (clk_clk_clk),                           //       clk.clk
		.reset               (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	niosII_mm_interconnect_0_rsp_demux_004 rsp_demux_010 (
		.clk                (clk_clk_clk),                                         //       clk.clk
		.reset              (cpu_reset_reset_bridge_in_reset_reset),               // clk_reset.reset
