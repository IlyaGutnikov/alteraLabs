...
set 	niosII_cpu_oci_im 	niosII_cpu_nios2_oci_im:the_niosII_cpu_nios2_oci_im
set 	niosII_cpu_oci_traceram 	niosII_cpu_traceram_lpm_dram_bdp_component_module:niosII_cpu_traceram_lpm_dram_bdp_component
set 	niosII_cpu_oci_itrace 	niosII_cpu_nios2_oci_itrace:the_niosII_cpu_nios2_oci_itrace
set 	niosII_cpu_oci_im_path 	 [format "%s|%s" $niosII_cpu_oci_path $niosII_cpu_oci_im]
set 	niosII_cpu_oci_itrace_path 	 [format "%s|%s" $niosII_cpu_oci_path $niosII_cpu_oci_itrace]
set 	niosII_cpu_traceram_path 	 [format "%s|%s" $niosII_cpu_oci_im_path $niosII_cpu_oci_traceram]
...
set_false_path -from [get_keepers *$niosII_cpu_oci_break_path|dbrk_hit?_latch] -to [get_keepers *$niosII_cpu_jtag_sr*]
set_false_path -from [get_keepers *$niosII_cpu_oci_break_path|trigbrktype] -to [get_keepers *$niosII_cpu_jtag_sr*]
set_false_path -from [get_keepers *$niosII_cpu_oci_break_path|trigger_state] -to [get_keepers *$niosII_cpu_jtag_sr*]

set_false_path -from [get_keepers *$niosII_cpu_traceram_path*address*] -to [get_keepers *$niosII_cpu_jtag_sr*]
set_false_path -from [get_keepers *$niosII_cpu_traceram_path*we_reg*] -to [get_keepers *$niosII_cpu_jtag_sr*]
set_false_path -from [get_keepers *$niosII_cpu_oci_im_path|*trc_im_addr*] -to [get_keepers *$niosII_cpu_jtag_sr*]
set_false_path -from [get_keepers *$niosII_cpu_oci_im_path|*trc_wrap] -to [get_keepers *$niosII_cpu_jtag_sr*]
set_false_path -from [get_keepers *$niosII_cpu_oci_itrace_path|trc_ctrl_reg*] -to [get_keepers *$niosII_cpu_jtag_sr*]
set_false_path -from [get_keepers *$niosII_cpu_oci_itrace_path|d1_debugack] -to [get_keepers *$niosII_cpu_jtag_sr*]
